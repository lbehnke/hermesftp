...
import de.apporiented.hermesftp.exception.FtpCmdResponseException;
import de.apporiented.hermesftp.exception.FtpIllegalCmdException;
import de.apporiented.hermesftp.exception.FtpQuitException;
import de.apporiented.hermesftp.parser.FtpCmdReader;
import de.apporiented.hermesftp.session.FtpSession;
...
public class FtpSessionImpl extends Thread implements FtpSession, FtpConstants {
    ...
    /**
     * @see de.apporiented.hermesftp.session.FtpSession#abort()
     */
    public void abort() {
        terminated = true;
    }
