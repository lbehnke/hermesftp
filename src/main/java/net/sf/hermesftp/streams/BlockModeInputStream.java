...
public class BlockModeInputStream
    ...
    private Map restartMarkers = new HashMap();
     ...
     * @param restartMarkers Hashtable to be filled with restart markers.
     */
    public BlockModeInputStream(InputStream is, byte[] eorMarker, Map restartMarkers) {
        super();
        this.is = is;
        if (eorMarker == null) {
