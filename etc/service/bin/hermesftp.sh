...
# Application
APP_NAME="HermesFTPServer"
APP_LONG_NAME="Hermes FTP Server Application"
HERMES_HOME="/home/lbehnke/prg/hermesftp"
...
# Path to Hermes FTP installation folder
REALDIR=$HERMES_HOME/service/bin
